...
with tab1:
    ...
    if search_query:
        ...
        utils.results_modules(utils.sort_BSc_modules(volltext_results), 'suche_volltext')
...
with tab2:
    ...
    if selected_name:
        ...
        utils.results_modules(utils.sort_BSc_modules(modulbeauftragte), 'suche_modulbeauftragte')
...
with tab3:
    ...
    if selected_cp:
        ...
        utils.results_modules(utils.sort_BSc_modules(modul_cp), 'suche_modul_cp')
